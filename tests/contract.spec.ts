...
describe('dsh-github wire contract', () => {
  ...
  it('validates wire values and projections', () => {
    ...
    expect(statusResultSchema.parse({ root: '/tmp/repo', branch: 'main', upstream: null, remoteName: null, ahead: 0, behind: 0, remoteUrl: null, githubUrl: null, files: [], truncated: false }).files).toEqual([])
