...
export const zh = {
  ...
  'panel.noUpstream': '未设置上游分支', 'panel.commitPlaceholder': '提交消息', 'panel.commit': '提交',
  ...
  'panel.currentBranch': '当前分支', 'panel.filesChanged': '个文件改动', 'panel.commitShortcut': '⌘/Ctrl+Enter 提交',
  ...
  'panel.branches': '分支', 'panel.remoteBranch': 'origin 远程分支', 'panel.localBranch': '本地分支',
  'panel.githubLinks': 'GitHub 链接', 'panel.openCompare': '在 GitHub 创建 Pull Request',
  'panel.noGithubRemote': '未检测到 GitHub origin 远程仓库。',
  ...
  'panel.operation.commit': '正在提交…', 'panel.operation.push': '正在推送…', 'panel.operation.fetch': '正在获取…',
...
export const en = {
  ...
  'panel.noUpstream': 'No upstream branch', 'panel.commitPlaceholder': 'Commit message', 'panel.commit': 'Commit',
  ...
  'panel.currentBranch': 'Current branch', 'panel.filesChanged': 'files changed', 'panel.commitShortcut': '⌘/Ctrl+Enter to commit',
  ...
  'panel.branches': 'Branches', 'panel.remoteBranch': 'origin remote branch', 'panel.localBranch': 'Local branch',
  'panel.githubLinks': 'GitHub links', 'panel.openCompare': 'Create Pull Request in GitHub',
  'panel.noGithubRemote': 'No GitHub origin remote detected.',
  'panel.operation.stage': 'Staging…', 'panel.operation.unstage': 'Unstaging…', 'panel.operation.stageAll': 'Staging all changes…',
  'panel.operation.unstageAll': 'Unstaging all changes…', 'panel.operation.commit': 'Committing…', 'panel.operation.push': 'Pushing…',
