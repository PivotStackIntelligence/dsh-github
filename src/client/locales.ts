...
export const zh = {
  ...
  'panel.currentBranch': '当前分支', 'panel.openBranch': '打开分支', 'panel.filesChanged': '个文件改动', 'panel.commitShortcut': '⌘/Ctrl+Enter 提交',
  ...
  'panel.branches': '分支', 'panel.localBranches': '本地分支', 'panel.remoteBranches': '远程分支', 'panel.remoteBranch': 'origin 远程分支', 'panel.localBranch': '本地分支',
...
export const en = {
  ...
  'panel.currentBranch': 'Current branch', 'panel.openBranch': 'Open branch', 'panel.filesChanged': 'files changed', 'panel.commitShortcut': '⌘/Ctrl+Enter to commit',
  ...
  'panel.branches': 'Branches', 'panel.localBranches': 'Local branches', 'panel.remoteBranches': 'Remote branches', 'panel.remoteBranch': 'origin remote branch', 'panel.localBranch': 'Local branch',
